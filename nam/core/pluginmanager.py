...
from nam.event import PluginEnabledEvent, PluginDisabledEvent
import nam.pluginmanagerbase
import nam.component as component

log = logging.getLogger(__name__)

class PluginManager(nam.pluginmanagerbase.PluginManagerBase,
    component.Component):
    ...
    def __init__(self, core):
        ...
        nam.pluginmanagerbase.PluginManagerBase.__init__(
            self, "core.conf", "nam.plugin.core")
