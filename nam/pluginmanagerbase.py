...
class PluginManagerBase:
    ...
    def __init__(self, config_file, entry_name):
        ...
        self.config = nam.configmanager.ConfigManager(config_file)

        # Create the plugins folder if it doesn't exist
        if not os.path.exists(os.path.join(nam.configmanager.get_config_dir(), "plugins")):
            os.mkdir(os.path.join(nam.configmanager.get_config_dir(), "plugins"))
    ...
    def scan_for_plugins(self):
        ...
        user_plugin_dir = os.path.join(nam.configmanager.get_config_dir(), "plugins")
