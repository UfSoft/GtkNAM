...
class _UI(object):
    ...
    def __init__(self, name="gtk"):
        ...
        self.__parser = OptionParser(version=nam.common.get_version())
    ...
    def start(self):
        ...
        log.info("NAM ui %s", nam.common.get_version())
...
#        log = logging.getLogger(__name__)
        ...
        config = nam.configmanager.ConfigManager("ui.conf", DEFAULT_PREFS)
        ...
        try:
            if selected_ui == "gtk":
                ...
                from nam.ui.gtkui.gtkui import GtkUI
                ui = GtkUI(args)
            elif selected_ui == "web":
                log.info("Starting WebUI..")
                from nam.ui.web.web import WebUI
                ui = WebUI(args)
            elif selected_ui == "console":
                log.info("Starting ConsoleUI..")
                from nam.ui.console.main import ConsoleUI
