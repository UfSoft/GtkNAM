...
import nam.ui.client
import nam.ui.common
...
class ConnectionManager(component.Component):
    ...
    def show(self):
        ...
        self.glade = gtk.glade.XML(
                    pkg_resources.resource_filename("nam.ui.gtkui",
        ...
        self.connection_manager.set_icon(common.get_nam_icon())
        ...
        try:
            ...
            if e.errno == 2:
                dialogs.ErrorDialog(
                    ...
                    _("Deluge cannot find the 'nam-daemon' executable, it is likely \
that you forgot to install the nam-daemon package or it's not in your PATH.")).run()
            else:
                raise e
        except Exception, e:
            import traceback
    ...
    def on_button_connect_clicked(self, widget=None):
        ...
        if status == _("Offline") and self.glade.get_widget("chk_autostart").get_active() and\
            ...
            self.start_daemon(port, nam.configmanager.get_config_dir())
    ...
    def on_button_addhost_clicked(self, widget):
        ...
        if response == 1:
            ...
            try:
                ...
                from nam.ui.gtkui.dialogs import ErrorDialog
                ErrorDialog(_("Error Adding Host"), e).run()

        username_entry.set_text("")
        password_entry.set_text("")
        hostname_entry.set_text("")
        port_spinbutton.set_value(56746)
        dialog.hide()
    ...
    def on_button_startdaemon_clicked(self, widget):
        ...
        if self.liststore.iter_n_children(None) < 1:
            ...
            self.start_daemon(DEFAULT_PORT, nam.configmanager.get_config_dir())
            return
