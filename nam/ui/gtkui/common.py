...
def get_logo(size):
    ...
    if nam.common.windows_check() or nam.common.osx_check():
        return gtk.gdk.pixbuf_new_from_file_at_size(
            nam.common.get_pixmap("nam.png"), size, size
        )
    else:
        return gtk.gdk.pixbuf_new_from_file_at_size(
            nam.common.get_pixmap("nam.png"), size, size
...
def show_other_dialog(header, type_str, image_stockid=None, image_filename=None, default=0):
    ...
    if image_filename:
        ...
        if os.path.splitext(image_filename)[1] == ".svg" and (common.windows_check() or common.osx_check()):
            image_filename = os.path.splitext(image_filename)[0] + "16.png"
        pixbuf = gtk.gdk.pixbuf_new_from_file_at_size(
            common.get_pixmap(image_filename), 32, 32)
...
def get_nam_icon():
    ...
    if nam.common.windows_check():
        ...
        try:
            ...
            return icon_theme.load_icon("nam", 64, 0)
        except:
            return get_logo(64)
